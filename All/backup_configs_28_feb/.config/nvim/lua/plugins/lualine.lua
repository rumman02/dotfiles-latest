...
M.opts = function()
	...
	local myFilename = function()
		...
		local icon = vim.bo.modified and " " .. icons.md_icons.documents.modified or "  "
	...
	local get_lsp_clients = function()
		...
		if #client_names > 0 then
			...
			result = icons.md_icons.others.flash .. " " .. table.concat(client_names, " | ")
		end
	...
	return {
		options = {
			...
			globalstatus = true,
			section_separators = {
				left = icons.separators.left_1,
				right = icons.separators.right_1,
			},
			component_separators = { left = icons.separators.left_2, right = icons.separators.right_2 },
			disabled_filetypes = {
				statusline = {
					-- "alpha",
					-- "snacks_dashboard",
			...
			lualine_a = {
				{
					"mode",
					fmt = function(str)
						return icons.md_icons.others.vim .. " " .. str
					end,
				...
				},
				{
					function()
						...
						return icons.md_icons.others.record .. "REC [ " .. reg .. " ]"
					end,
				},
			},
			lualine_b = {
			...
			lualine_y = {
				{
					...
					symbols = {
						...
						removed = icons.md_icons.git.removed .. " ",
					},
				},
				{
					"diagnostics",
