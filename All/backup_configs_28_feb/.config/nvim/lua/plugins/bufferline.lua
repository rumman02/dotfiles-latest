...
M.opts = function ()
	...
	return {
		options = {
			...
			buffer_close_icon = " " .. icons.md_icons.ui.close .. " ",
			modified_icon = icons.md_icons.documents.modified .. " ",
			close_icon = icons.md_icons.ui.close,
			left_trunc_marker = icons.md_icons.ui.arrow_left,
			right_trunc_marker = icons.md_icons.ui.arrow_right,
			diagnostics = "nvim_lsp",
			---@diagnostic disable-next-line: unused-local
			diagnostics_indicator = function(count, level, diagnostics_dict, context)
				local s = ""
				for e, n in pairs(diagnostics_dict) do
					local sym = e == "error" and  " " .. icons.md_icons.diagnostics.error .. " "
					or (
					e == "warning" and " " .. icons.md_icons.diagnostics.warn .. " "
					or " " .. icons.md_icons.diagnostics.hint .. " "
					)
					s = s .. n .. sym
				end
				return s
...
M.keys = function()
	...
	local tab_leader = require("lib.keys").tab_leader
	local window_leader = require("lib.keys").window_leader
