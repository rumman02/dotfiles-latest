...
M.config = function ()
	vim.api.nvim_create_autocmd("Filetype", {
		...
		callback = function ()
			local telescope_local_leader = require("lib.keys").telescope_local_leader
			...
			map(0, { "n" }, telescope_local_leader .. "aa", nil, { desc = "All", buffer = true })
			map(0, { "n" }, telescope_local_leader .. "as", nil, { desc = "Selected", buffer = true })
...
M.keys= function ()
	local telescope_leader = require("lib.keys").telescope_leader
	local git_leader = require("lib.keys").git_leader
	return {
