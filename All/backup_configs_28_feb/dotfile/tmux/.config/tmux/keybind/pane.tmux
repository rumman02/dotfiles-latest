# pane (p)
bind-key -rT prefix p switch-client -T pane								# pane

# pane open (p-o)
bind-key -rT pane o switch-client -T pane_open							# pane - open
...
# pane close (p-x)
bind-key -rT pane x switch-client -T pane_close							# pane - close
...
# pane resize (p-r)
bind-key -rT pane r switch-client -T pane_resize							# pane - resize
...
# pane swap (p-s)
bind-key -rT pane s switch-client -T pane_swap							# pane - swap
...
bind-key -rT pane w switch-client -T pane_window							# pane - swap
...
# pane tree (p-t)
bind-key -rT pane t choose-tree
