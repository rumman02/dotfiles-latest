  ...
  config = function()
    ...
    fidget.setup({
      ...
      progress = {
        ...
        end,                                                                        -- Clear notification group when LSP server detaches
      ...
      integration = {
        ["nvim-tree"]       = { enable = true }, -- Integrate with nvim-tree/nvim-tree.lua (if installed)
        ["xcodebuild-nvim"] = { enable = true }, -- Integrate with wojciech-kulik/xcodebuild.nvim (if installed)
      },
