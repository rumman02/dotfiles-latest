		...
		for (( i=0; i<${#neovim_colorscheme_value}; i++ )); do
			...
			case "$char" in
				...
				"5")
					...
					# },
					newLine3="${overrides}{ SignColumn = { bg = \"none\" }, FloatBorder = { link = \"GruvboxBg2\" }, CmpBorder = { link = \"GruvboxBg2\" }, CmpDocBorder = { link = \"GruvboxBg2\" }, WhichKeyBorder = { link = \"GruvboxBg2\" }, FlashLabel = { fg = \"#fff100\" }, NeotreeNormal = { bg = \"#1c1c1c\" }, NeotreeNormalNC = { bg = \"#1c1c1c\" }, },"
					;;
				"6")
					newLine1="${contrast}\"hard\","
					newLine2="${background}\"dark\""
