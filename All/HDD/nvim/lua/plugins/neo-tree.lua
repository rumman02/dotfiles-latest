...
M.opts = function(_, opts)
	...
	local explorer_local_leader = require("lib.keys").explorer_local_leader
	...
	source_selector = {
		...
		sources = {
			{
				source = "filesystem",
				display_name = " " .. icons.md_icons.documents.folder_closed .. " Folders",
			},
			{
				source = "buffers",
				display_name = " " .. icons.md_icons.others.buffers .. " Buffers",
			},
			{
				source = "git_status",
				display_name = icons.md_icons.git.logo .. " Status",
			},
		},
	...
	default_component_configs = {
		indent = {
			indent_size = utils.options.indent_size,
			indent_marker = icons.indent.char,
			last_indent_marker = icons.indent.last_char .. icons.indent.bottom_char,
		},
		icon = {
			folder_closed = icons.md_icons.documents.folder_closed,
			folder_open = icons.md_icons.documents.folder_opened,
			folder_empty = icons.md_icons.documents.folder_empty,
		},
		modified = {
			symbol = icons.md_icons.documents.modified,
		},
		diagnostics = {
			symbols = {
				hint = icons.md_icons.diagnostics.hint,
				info = icons.md_icons.diagnostics.info,
				warn = icons.md_icons.diagnostics.warn,
				error = icons.md_icons.diagnostics.error,
			},
		},
		name = {
		...
		git_status = {
			symbols = {
				added = icons.md_icons.git.added,
				deleted = icons.md_icons.git.deleted,
				modified = icons.md_icons.git.modified,
				renamed = icons.md_icons.git.renamed,
				untracked = icons.md_icons.git.untracked,
				ignored = icons.md_icons.git.ignored,
				unstaged = icons.md_icons.git.unstaged,
				staged = icons.md_icons.git.staged,
				conflict = icons.md_icons.git.conflict,
			},
		},
	},
	window = {
