# session
bind-key -rT prefix s switch-client -T session							# session

# session open (s-o)
bind-key -rT session o switch-client -T session_open						# session open
...
bind-key -rT session_open n switch-client -T session_open_name			# session open with name
...
# session close (s-x)
bind-key -rT session x switch-client -T session_close					# session close
...
# session lists (s-t)
bind-key -rT session t choose-tree -s									# open session list

# session rename (s-n)
bind-key -rT session n command-prompt -p "Session name:" "rename-session '%%'"	# rename current session
