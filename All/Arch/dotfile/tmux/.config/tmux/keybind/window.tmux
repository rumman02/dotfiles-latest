# window
bind-key -rT prefix w switch-client -T window							# window

# window (w-o)
bind-key -rT window o switch-client -T window_open						# window open
bind-key -rT window_open h new-window -b -d								# Open left
bind-key -rT window_open l new-window -a -d								# Open right
bind-key -rT window_open n switch-client -T window_open_name				# window open name
...
# window (w-x)
bind-key -rT window x switch-client -T window_close					# window close
...
# window swap (p-s)
bind-key -rT window s switch-client -T window_swap						# window swap
bind-key -rT window_swap h swap-window -d -t:-1							# swap with previous
bind-key -rT window_swap l swap-window -d -t:+1							# swap with next

# window list (w-t)
bind-key -rT window t choose-tree -w

# window rename (w-n)
bind-key -rT window n command-prompt -p "Window name:" "rename-window '%%'"
