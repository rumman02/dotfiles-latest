return {
	...
	opts = {
		overrides = {
			...
			RenderMarkdownH1Bg = { fg = "#282828", bg = "#fb4934" }, -- red
			RenderMarkdownH2Bg = { fg = "#282828", bg = "#fe8019" }, -- orange
			RenderMarkdownH3Bg = { fg = "#282828", bg = "#fabd2f" }, -- yellow
			RenderMarkdownH4Bg = { fg = "#282828", bg = "#b8bb26" }, -- green
			RenderMarkdownH5Bg = { fg = "#282828", bg = "#83a598" }, -- blue-gray
			RenderMarkdownH6Bg = { fg = "#ebdbb2", bg = "#504945" }, -- soft contrast
