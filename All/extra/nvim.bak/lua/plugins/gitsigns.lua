...
M.opts = function()
	...
	return {
		signs = {
			add = { text = icons.md_icons.git.added },
			change = { text = icons.md_icons.git.modified },
			delete = { text = icons.md_icons.git.removed },
			topdelete = { text = icons.md_icons.git.removed },
			changedelete = { text = icons.md_icons.git.modified },
			untracked = { text = icons.md_icons.git.untracked },
		},
		-- signs_staged = {
		-- 	add = { text = icons.md_icons.git.added },
		-- 	change = { text = icons.md_icons.git.modified },
